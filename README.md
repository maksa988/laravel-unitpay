...
[![Build Status](https://travis-ci.org/maksa988/laravel-unitpay.svg?branch=1.x)](https://travis-ci.org/maksa988/laravel-unitpay)
[![StyleCI](https://github.styleci.io/repos/165841601/shield?branch=1.x)](https://github.styleci.io/repos/165841601)
...
``` bash
composer require "maksa988/laravel-unitpay:1.*"
```
